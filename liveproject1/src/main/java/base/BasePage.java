...
public class BasePage {
	...
	public BasePage() throws IOException {
		...
		FileInputStream data = new FileInputStream(
				System.getProperty("user.dir")+ "\\src\\main\\java\\resources\\config.properties"); //da bi kod mogao da se koristi
		//kada npr nekome posaljemo projekat, jer pocinje putanja od projekta a ne od racunara
		prop.load(data);
	}
